...
const SLIDES: Slide[] = [
  {
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        text: 'Проте до такого відчуття приходять не через силу волі чи ідеальну дисципліну. І хоча зараз у мене є той самий ключ, який відкриває двері у світ, де мова стає частиною життя без виснаження і стресу... так було не завжди.',
      },
    ],
  ...
  },
  {
    kind: 'photo-text',
    paragraphs: [
      'Моє знайомство з англійською почалося рано. Мені було п’ять років, коли мама запросила для мене викладача. Я досі пам’ятаю це відчуття зацікавленості та легкості, з яким чекала кожного заняття.',
      ...
      'У пошуках відповіді я занурилася у вивчення психофізіології та роботи мозку. Спостерігаючи за дітьми, я бачила, як природно вони входять у мову. Вони не бояться помилок, не переживають через рівень і не відкладають практику — вони просто взаємодіють зі світом.',
    ],
    photoSrc: '/51.jpg',
