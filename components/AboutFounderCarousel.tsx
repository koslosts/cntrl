...
const SLIDES: Slide[] = [
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'Сьогодні англійська для мене — це не просто навичка, а те, що робить життя значно ширшим. Можливість читати в оригіналі, вільно рухатися між культурами й знаходити відповіді там, де вони народжуються, а не чекати на переклад. Вона давно перестала бути окремим завданням та стала частиною повсякдення — такою ж природною, як ранкова кава, улюблений подкаст за кермом чи книга біля каміну наприкінці дня.',
      },
      {
        type: 'quote',
