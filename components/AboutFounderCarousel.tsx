...
const SLIDES: Slide[] = [
  {
    ...
    blocks: [
      ...
      {
        type: 'paragraph',
        text: 'Але я добре пам’ятаю, що до цього відчуття приходять не через силу волі чи ідеальну дисципліну — і хоча зараз у мене є той самий ключ, який відкриває двері у світ, де англійська стає природною частиною життя без виснаження і стресу, так було не завжди.',
      },
    ],
