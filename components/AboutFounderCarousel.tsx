...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'paragraph', text: 'З роками я помітила чітку закономірність. Топменеджери, підприємці та лідери думок часто говорили про мову однаковими словами: «не вистачає часу», «не виходить бути регулярним», «занадто багато разів починав спочатку», «не хочу перетворювати життя на ще один марафон самовдосконалення».' },
  ...
  },
  {
    kind: 'photo-text',
    paragraphs: [
      'Саме тоді почала формуватися ідея The Key — спроба відповісти на просте запитання: як має виглядати навчання для людини, яка вже має насичене життя?',
      ...
      'Поступово цей підхід почав працювати: зникала напруга, з’являлися комфорт, цікавість, впевненість і вибір — а англійська ставала тихою розкішшю. Запрошую Вас отримати свій персональний ключ.',
    ],
    photoSrc: '/38.jpg',
...
const MOBILE_SLIDE_3B: Slide = {
  ...
  blocks: [
    ...
    { type: 'quote', text: '«Іванно, англійська потрібна мені щодня. Але від самої думки про чергове навчання я вже втомився».' },
    { type: 'paragraph', text: 'І в цій фразі було набагато більше правди, ніж здається на перший погляд.' },
    { type: 'paragraph', text: 'Саме тоді почала формуватися ідея The Key — спроба відповісти на просте запитання: як має виглядати навчання для людини, яка вже має насичене життя?' },
  ],
};
