...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'У пошуках відповіді я занурилася у вивчення розвитку дітей та процесів навчання. Спостерігаючи за дітьми, я бачила, наскільки природно вони входять у нову мову — їх не лякають помилки. Так з’явилася Richmond Child.',
    ],
    photoSrc: '/51.jpg',
