...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Пізніше були школа, університет, професійний розвиток і знайомий багатьом досвід, коли навчання починає асоціюватися не з відкриттями, а з вимогами й напругою. Чому одні люди навчаються із задоволенням, а інші швидко втрачають мотивацію?',
      'У пошуках відповіді я занурилася у вивчення розвитку дітей та процесів навчання. Спостерігаючи за ними, я бачила, наскільки природно вони входять у нову мову — їх не лякають помилки. Так з’явилася Richmond Child. Але вони поставили переді мною інше питання: що потрібно змінити, щоб дорослі теж могли навчатися без зайвого напруження?',
    ],
    photoSrc: '/51.jpg',
  ...
  },
  {
    kind: 'columns',
    paragraphs: [
      'З роками я почала помічати закономірність. Батьки наших учнів, підприємці, керівники, фахівці, експерти та власники бізнесів часто говорили про англійську однаковими словами: не вистачає часу, не виходить бути регулярним, занадто багато разів починав спочатку.',
      'Мені потрібна англійська, але я не хочу перетворювати життя на ще один марафон самовдосконалення — це фраза, яку я чула найчастіше.',
      'Щоразу мене дивувало одне й те саме: ці люди успішно реалізовували складні проєкти, керували командами, запускали бізнеси та освоювали нові професійні сфери. Проблема була не у відсутності здібностей. Проблема була у форматі.',
      'Більшість навчальних програм вимагали від дорослої людини поводитися так, ніби вона має нескінченний запас часу, уваги та енергії. Але реальне життя влаштоване інакше.',
      '«Іванно, англійська потрібна мені щодня. Але від самої думки про навчання я вже втомився», — сказав мені один із наших клієнтів. І в цій фразі було набагато більше правди, ніж здається на перший погляд.',
    ],
  },
  {
    kind: 'columns',
    paragraphs: [
      ...
      'Мені хотілося створити формат, де англійська не конкурує з роботою, сім’єю, відпочинком чи особистими проєктами. Формат, який не вимагає постійно «знаходити час», а враховує реальний ритм життя людини.',
      'Поступово цей підхід почав працювати. Для когось англійська повернулася через професійні розмови, для когось — через книги та подкасти, для когось — через подорожі або нові кар’єрні можливості. Але майже завжди зміни починалися в одному місці: зникала напруга.',
      'А разом із цим з’являвся простір для природного розвитку. Так народився індивідуальний мовний супровід The Key.',
      'За роки роботи я переконалася, що дорослі люди рідко потребують більшого тиску. Набагато частіше вони потребують середовища, у якому можуть рухатися вперед стабільно та у власному темпі.',
    ],
  },
];
