...
const SLIDES: Slide[] = [
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'Сьогодні англійська для мене — це не просто навичка чи професійний інструмент. Це те, що робить життя значно ширшим.',
      },
      {
        type: 'paragraph',
        text: 'Можливість читати книги мовою оригіналу й слухати людей, чиї ідеї надихають. Вільно рухатися між культурами, країнами та професійними середовищами. Знаходити відповіді там, де вони народжуються, а не чекати на переклад.',
      },
      {
        type: 'paragraph',
        text: 'Англійська давно перестала бути окремим завданням. Вона стала частиною повсякденного життя — такою ж природною, як ранкова кава, улюблений подкаст за кермом чи книга біля каміну наприкінці дня.',
      },
      {
        type: 'quote',
      ...
      {
        type: 'paragraph',
        text: 'Проте я добре пам’ятаю, що до такого відчуття приходять не через силу волі чи ідеальну дисципліну.',
      },
      {
        type: 'paragraph',
        text: 'І хоча зараз у мене є той самий ключ, який відкриває двері у світ, де англійська стає природною частиною життя без виснаження і стресу... так було не завжди.',
      },
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Пізніше були школа, університет і знайомий багатьом досвід, коли навчання поступово починає асоціюватися не з відкриттями, а з вимогами й внутрішньою напругою. Саме тоді мене зацікавило питання, яке згодом визначило мою професійну діяльність: чому одні люди навчаються із задоволенням, а інші, маючи не менші здібності, швидко втрачають мотивацію?',
      'У пошуках відповіді я занурилася у вивчення психофізіології, роботи мозку та процесів навчання на різних етапах життя. Спостерігаючи за дітьми, я бачила, наскільки природно вони входять у нову мову. Їх не лякають помилки. Вони не переживають через рівень і не відкладають практику до кращих часів — вони просто взаємодіють зі світом.',
    ],
    photoSrc: '/51.jpg',
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'paragraph', text: 'Але діти поставили переді мною інше питання: що потрібно змінити, аби успішні, зайняті люди також могли повертати собі цю легкість і навчатися без зайвого напруження?' },
      { type: 'paragraph', text: 'З роками я помітила чітку закономірність. Топменеджери, підприємці та лідери думок часто говорили про мову однаковими словами: «не вистачає часу», «не виходить бути регулярним», «занадто багато разів починав спочатку».' },
      { type: 'paragraph', text: '«Мені потрібна англійська, але я не хочу перетворювати своє життя на ще один марафон самовдосконалення» — це фраза, яку я чула найчастіше.' },
      { type: 'paragraph', text: '«Ці люди успішно реалізовували масштабні проєкти, керували компаніями й запускали бізнеси. Проблема була не у відсутності здібностей чи сили волі. Проблема була у форматі».' },
      { type: 'paragraph', text: 'Більшість навчальних програм вимагають від дорослих людей поводитися так, ніби вони мають нескінченний запас часу, уваги та енергії. Але реальне життя влаштоване інакше.' },
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Поступово цей підхід почав працювати. Але майже завжди зміни починалися в одному місці — зникала напруга. Натомість з’являвся комфорт, цікавість, впевненість і вибір. А разом із цим з’являвся простір для природного розвитку, а англійська ставала частиною життя — тихою розкішшю.',
