...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Пізніше були школа, університет, професійний розвиток і знайомий багатьом досвід, коли навчання поступово починає асоціюватися не з відкриттями, а з вимогами, оцінюванням і внутрішньою напругою. Чому одні люди навчаються із задоволенням, а інші, маючи не менші здібності, швидко втрачають мотивацію?',
      'У пошуках відповіді я занурилася у вивчення розвитку дітей, формування мовлення та процесів навчання. Спостерігаючи за дітьми, я бачила, наскільки природно вони входять у нову мову. Їх не лякають помилки. Вони не переживають через рівень. Не відкладають практику до кращих часів. Так з’явилася Richmond Child. Але вони поставили переді мною інше питання: що потрібно змінити, щоб дорослі теж могли навчатися без зайвого напруження?',
    ],
    photoSrc: '/51.jpg',
